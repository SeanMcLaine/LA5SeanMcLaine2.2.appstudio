...
const cacheName = 'LA5SeanMcLaine2-2021-09-22 19:23:56.923914'; // unique value, generated each deploy
  ...
  e.waitUntil(
    caches.keys().then((keyList) => {
      ...
      return Promise.all(keyList.map((key) => {
        ...
        if (cacheName.indexOf(key) === -1  && key.substr(0, 'LA5SeanMcLaine2'.length) === 'LA5SeanMcLaine2') {
